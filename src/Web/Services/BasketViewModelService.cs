...
namespace Web.Services
{
    public class BasketViewModelService : IBasketViewModelService
    {
        ...
        public BasketViewModelService(IHttpContextAccessor httpContextAccessor, IRepository<Basket> basketRepository, 
            IRepository<Product> productRepository, IBasketService basketService )
        {
